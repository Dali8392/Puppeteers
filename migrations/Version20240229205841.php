 ...
 */
final class Version20240229205841 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation_voyage CHANGE date date DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation_voyage CHANGE date date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
