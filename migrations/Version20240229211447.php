 ...
 */
final class Version20240229211447 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hebergement CHANGE user_id user_id VARCHAR(10) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE hebergement RENAME INDEX fk_4852dd9ca76ed395 TO IDX_4852DD9CA76ED395');
        ...
        $this->addSql('ALTER TABLE reservation_voyage ADD voyage_id_id INT NOT NULL, CHANGE date date DATETIME NOT NULL');
        ...
        $this->addSql('ALTER TABLE reservation_voyage ADD CONSTRAINT FK_776CC0CE75D4A2B8 FOREIGN KEY (voyage_id_id) REFERENCES voyage (id)');
        $this->addSql('CREATE INDEX IDX_776CC0CE75D4A2B8 ON reservation_voyage (voyage_id_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hebergement CHANGE user_id user_id INT NOT NULL');
        $this->addSql('ALTER TABLE hebergement RENAME INDEX idx_4852dd9ca76ed395 TO FK_4852DD9CA76ED395');
        ...
        $this->addSql('ALTER TABLE reservation_voyage DROP FOREIGN KEY FK_776CC0CE75D4A2B8');
        $this->addSql('DROP INDEX IDX_776CC0CE75D4A2B8 ON reservation_voyage');
        $this->addSql('ALTER TABLE reservation_voyage DROP voyage_id_id, CHANGE date date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
