 ...
 */
final class Version20240220143332 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hebergement RENAME INDEX fk_user TO IDX_4852DD9CA76ED395');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hebergement RENAME INDEX idx_4852dd9ca76ed395 TO fk_user');
