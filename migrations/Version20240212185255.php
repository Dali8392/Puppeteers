 ...
 */
final class Version20240212185255 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE voyage CHANGE date_dep date_dep DATE NOT NULL, CHANGE date_arr date_arr DATE NOT NULL, CHANGE heure_dep heure_dep TIME NOT NULL, CHANGE heure_arr heure_arr TIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE voyage CHANGE date_dep date_dep DATETIME NOT NULL, CHANGE date_arr date_arr DATETIME NOT NULL, CHANGE heure_dep heure_dep DATETIME NOT NULL, CHANGE heure_arr heure_arr DATETIME NOT NULL');
    }
}
