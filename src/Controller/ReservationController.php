...
class ReservationController extends AbstractController
{
    ...
    public function newv(Request $request,SessionInterface $session): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $reservationVoyage->setIdUser($session->get('id'));
             $entityManager = $this->getDoctrine()->getManager();
    ...
    public function deleteReservationVoyage(Request $request, ReservationVoyage $reservation): Response
    {
     ...
     public function newh(Request $request,SessionInterface $session): Response
     {
         ...
         if ($form->isSubmitted() && $form->isValid()) {
            $reservationHebergement->setIdUser($session->get('id'));
             $entityManager = $this->getDoctrine()->getManager();
