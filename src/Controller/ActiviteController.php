...
{ 
    ...
    public function showActivityWithWeather($city)
    {
        $apiKey = 'e319fbb5708e8aaf0668e0e977156887';
        $httpClient = HttpClient::create();
        $response = $httpClient->request('GET', 'http://api.weatherapi.com/v1/forecast.json?key=' . $apiKey . '&q=' . urlencode($city) . '&days=7');
    
        $weatherData = $response->toArray();
    
        // Assuming you have the $activity variable available with the relevant activity details
