...
<<<<<<< HEAD
     ...
     */
    public function getReservationvoyage(): Collection
    {
    ...
    {
        if (!$this->reservationvoyage->contains($reservationvoyage)) {
            $this->reservationvoyage->add($reservationvoyage);
    ...
    {
        if ($this->reservationvoyage->removeElement($reservationvoyage)) {
